require(['jquery', 'bootstrap','jquery.ui',
        'jquery.migrate',
        'jquery.easing', 'superfish', 'select2',
        'jquery.parallax.resize','SmoothScroll', 'jquery.appear',
        'jquery.caroufredsel', 'jquery.touchSwipe', 'jquery.ui.totop'],
    function($) {
